...
TW_VISIBILITY_DEFAULT TWData *_Nonnull TWAnySignerSign(TWData *_Nonnull input, enum TWCoinType coin);
...
TW_VISIBILITY_DEFAULT TWString *_Nonnull TWAnySignerSignJSON(TWString *_Nonnull json, TWData *_Nonnull key, enum TWCoinType coin);
...
TW_VISIBILITY_DEFAULT bool TWAnySignerSupportsJSON(enum TWCoinType coin);
...
TW_VISIBILITY_DEFAULT TWData *_Nonnull TWAnySignerPlan(TWData *_Nonnull input, enum TWCoinType coin);
