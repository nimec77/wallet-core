...
#define TW_EXPORT_FUNC TW_VISIBILITY_DEFAULT

// Marker for exported methods
#define TW_EXPORT_METHOD TW_VISIBILITY_DEFAULT

// Marker for exported properties
#define TW_EXPORT_PROPERTY TW_VISIBILITY_DEFAULT

// Marker for exported static methods
#define TW_EXPORT_STATIC_METHOD TW_VISIBILITY_DEFAULT

// Marker for exported static properties
#define TW_EXPORT_STATIC_PROPERTY TW_VISIBILITY_DEFAULT
