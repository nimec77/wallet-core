...
final class BitcoinAddress implements Disposable, Address {
    ...
    factory BitcoinAddress.createWithString(String string) {
    ...
    factory BitcoinAddress.createWithData(Uint8List data) {
    ...
    factory BitcoinAddress.createWithPublicKey(PublicKey publicKey, int prefix) {
