...
final $typed_data.Uint8List messageBehaviorDescriptor =
    $convert.base64Decode('Cg9NZXNzYWdlQmVoYXZpb3ISEgoOU2ltcGxlVHJhbnNmZXIQABISCg5TZW5kQWxsQmFsYW5jZR'
        'AB');
...
final $typed_data.Uint8List transferDescriptor =
    $convert.base64Decode('CghUcmFuc2ZlchIWCgZib3VuY2UYASABKAhSBmJvdW5jZRI/CghiZWhhdmlvchgCIAEoDjIjLl'
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSOgoIdHJhbnNmZXIYASABKAsyHC5UVy5FdmVyc2NhbGUuUHJvdG8uVH'
...
final $typed_data.Uint8List signingOutputDescriptor =
    $convert.base64Decode('Cg1TaWduaW5nT3V0cHV0EhgKB2VuY29kZWQYASABKAlSB2VuY29kZWQ=');
