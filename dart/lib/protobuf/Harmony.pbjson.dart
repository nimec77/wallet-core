...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSGQoIY2hhaW5faWQYASABKAxSB2NoYWluSWQSHwoLcHJpdmF0ZV9rZX'
...
final $typed_data.Uint8List transactionMessageDescriptor =
    $convert.base64Decode('ChJUcmFuc2FjdGlvbk1lc3NhZ2USFAoFbm9uY2UYASABKAxSBW5vbmNlEhsKCWdhc19wcmljZR'
...
final $typed_data.Uint8List stakingMessageDescriptor =
    $convert.base64Decode('Cg5TdGFraW5nTWVzc2FnZRJmChhjcmVhdGVfdmFsaWRhdG9yX21lc3NhZ2UYASABKAsyKi5UVy'
...
final $typed_data.Uint8List descriptionDescriptor =
    $convert.base64Decode('CgtEZXNjcmlwdGlvbhISCgRuYW1lGAEgASgJUgRuYW1lEhoKCGlkZW50aXR5GAIgASgJUghpZG'
...
final $typed_data.Uint8List decimalDescriptor =
    $convert.base64Decode('CgdEZWNpbWFsEhQKBXZhbHVlGAEgASgMUgV2YWx1ZRIcCglwcmVjaXNpb24YAiABKAxSCXByZW'
        'Npc2lvbg==');
...
final $typed_data.Uint8List commissionRateDescriptor =
    $convert.base64Decode('Cg5Db21taXNzaW9uUmF0ZRItCgRyYXRlGAEgASgLMhkuVFcuSGFybW9ueS5Qcm90by5EZWNpbW'
...
final $typed_data.Uint8List directiveCreateValidatorDescriptor =
    $convert.base64Decode('ChhEaXJlY3RpdmVDcmVhdGVWYWxpZGF0b3ISKwoRdmFsaWRhdG9yX2FkZHJlc3MYASABKAlSEH'
...
final $typed_data.Uint8List directiveEditValidatorDescriptor =
    $convert.base64Decode('ChZEaXJlY3RpdmVFZGl0VmFsaWRhdG9yEisKEXZhbGlkYXRvcl9hZGRyZXNzGAEgASgJUhB2YW'
...
final $typed_data.Uint8List directiveDelegateDescriptor =
    $convert.base64Decode('ChFEaXJlY3RpdmVEZWxlZ2F0ZRIrChFkZWxlZ2F0b3JfYWRkcmVzcxgBIAEoCVIQZGVsZWdhdG'
...
final $typed_data.Uint8List directiveUndelegateDescriptor =
    $convert.base64Decode('ChNEaXJlY3RpdmVVbmRlbGVnYXRlEisKEWRlbGVnYXRvcl9hZGRyZXNzGAEgASgJUhBkZWxlZ2'
...
final $typed_data.Uint8List directiveCollectRewardsDescriptor =
    $convert.base64Decode('ChdEaXJlY3RpdmVDb2xsZWN0UmV3YXJkcxIrChFkZWxlZ2F0b3JfYWRkcmVzcxgBIAEoCVIQZG'
