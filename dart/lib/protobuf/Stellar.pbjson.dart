...
final $typed_data.Uint8List claimPredicateDescriptor =
    $convert.base64Decode('Cg5DbGFpbVByZWRpY2F0ZRIbChdQcmVkaWNhdGVfdW5jb25kaXRpb25hbBAA');
...
final $typed_data.Uint8List assetDescriptor =
    $convert.base64Decode('CgVBc3NldBIWCgZpc3N1ZXIYASABKAlSBmlzc3VlchIcCglhbHBoYW51bTQYAiABKAlSCWFscG'
        'hhbnVtNA==');
...
final $typed_data.Uint8List operationCreateAccountDescriptor =
    $convert.base64Decode('ChZPcGVyYXRpb25DcmVhdGVBY2NvdW50EiAKC2Rlc3RpbmF0aW9uGAEgASgJUgtkZXN0aW5hdG'
...
final $typed_data.Uint8List operationPaymentDescriptor =
    $convert.base64Decode('ChBPcGVyYXRpb25QYXltZW50EiAKC2Rlc3RpbmF0aW9uGAEgASgJUgtkZXN0aW5hdGlvbhItCg'
...
final $typed_data.Uint8List operationChangeTrustDescriptor =
    $convert.base64Decode('ChRPcGVyYXRpb25DaGFuZ2VUcnVzdBItCgVhc3NldBgBIAEoCzIXLlRXLlN0ZWxsYXIuUHJvdG'
...
final $typed_data.Uint8List claimantDescriptor =
    $convert.base64Decode('CghDbGFpbWFudBIYCgdhY2NvdW50GAEgASgJUgdhY2NvdW50Ej4KCXByZWRpY2F0ZRgCIAEoDj'
...
final $typed_data.Uint8List operationCreateClaimableBalanceDescriptor =
    $convert.base64Decode('Ch9PcGVyYXRpb25DcmVhdGVDbGFpbWFibGVCYWxhbmNlEi0KBWFzc2V0GAEgASgLMhcuVFcuU3'
...
final $typed_data.Uint8List operationClaimClaimableBalanceDescriptor =
    $convert.base64Decode('Ch5PcGVyYXRpb25DbGFpbUNsYWltYWJsZUJhbGFuY2USHQoKYmFsYW5jZV9pZBgBIAEoDFIJYm'
        'FsYW5jZUlk');
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSEAoDZmVlGAEgASgFUgNmZWUSGgoIc2VxdWVuY2UYAiABKANSCHNlcX'
...
final $typed_data.Uint8List signingOutputDescriptor =
    $convert.base64Decode('Cg1TaWduaW5nT3V0cHV0EhwKCXNpZ25hdHVyZRgBIAEoCVIJc2lnbmF0dXJlEjMKBWVycm9yGA'
