...
final $typed_data.Uint8List rewardDestinationDescriptor =
    $convert.base64Decode('ChFSZXdhcmREZXN0aW5hdGlvbhIKCgZTVEFLRUQQABIJCgVTVEFTSBABEg4KCkNPTlRST0xMRV'
        'IQAg==');
...
final $typed_data.Uint8List eraDescriptor =
    $convert.base64Decode('CgNFcmESIQoMYmxvY2tfbnVtYmVyGAEgASgEUgtibG9ja051bWJlchIWCgZwZXJpb2QYAiABKA'
        'RSBnBlcmlvZA==');
...
final $typed_data.Uint8List customCallIndicesDescriptor =
    $convert.base64Decode('ChFDdXN0b21DYWxsSW5kaWNlcxIhCgxtb2R1bGVfaW5kZXgYBCABKAVSC21vZHVsZUluZGV4Ei'
...
final $typed_data.Uint8List callIndicesDescriptor =
    $convert.base64Decode('CgtDYWxsSW5kaWNlcxI+CgZjdXN0b20YASABKAsyJC5UVy5Qb2xrYWRvdC5Qcm90by5DdXN0b2'
...
final $typed_data.Uint8List balanceDescriptor =
    $convert.base64Decode('CgdCYWxhbmNlEkEKCHRyYW5zZmVyGAEgASgLMiMuVFcuUG9sa2Fkb3QuUHJvdG8uQmFsYW5jZS'
...
final $typed_data.Uint8List stakingDescriptor =
    $convert.base64Decode('CgdTdGFraW5nEjUKBGJvbmQYASABKAsyHy5UVy5Qb2xrYWRvdC5Qcm90by5TdGFraW5nLkJvbm'
...
final $typed_data.Uint8List identityDescriptor =
    $convert.base64Decode('CghJZGVudGl0eRJgChRqb2luX2lkZW50aXR5X2FzX2tleRgBIAEoCzItLlRXLlBvbGthZG90Ll'
...
final $typed_data.Uint8List polymeshCallDescriptor =
    $convert.base64Decode('CgxQb2x5bWVzaENhbGwSQgoNaWRlbnRpdHlfY2FsbBgCIAEoCzIbLlRXLlBvbGthZG90LlByb3'
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSHQoKYmxvY2tfaGFzaBgBIAEoDFIJYmxvY2tIYXNoEiEKDGdlbmVzaX'
