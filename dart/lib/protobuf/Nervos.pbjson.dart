...
final $typed_data.Uint8List transactionPlanDescriptor =
    $convert.base64Decode('Cg9UcmFuc2FjdGlvblBsYW4SNQoJY2VsbF9kZXBzGAEgAygLMhguVFcuTmVydm9zLlByb3RvLk'
...
final $typed_data.Uint8List cellDepDescriptor =
    $convert.base64Decode('CgdDZWxsRGVwEhkKCGRlcF90eXBlGAEgASgJUgdkZXBUeXBlEjYKCW91dF9wb2ludBgCIAEoCz'
...
final $typed_data.Uint8List outPointDescriptor =
    $convert.base64Decode('CghPdXRQb2ludBIXCgd0eF9oYXNoGAEgASgMUgZ0eEhhc2gSFAoFaW5kZXgYAiABKA1SBWluZG'
        'V4');
...
final $typed_data.Uint8List cellOutputDescriptor =
    $convert.base64Decode('CgpDZWxsT3V0cHV0EhoKCGNhcGFjaXR5GAEgASgEUghjYXBhY2l0eRIrCgRsb2NrGAIgASgLMh'
...
final $typed_data.Uint8List scriptDescriptor =
    $convert.base64Decode('CgZTY3JpcHQSGwoJY29kZV9oYXNoGAEgASgMUghjb2RlSGFzaBIbCgloYXNoX3R5cGUYAiABKA'
...
final $typed_data.Uint8List nativeTransferDescriptor =
    $convert.base64Decode('Cg5OYXRpdmVUcmFuc2ZlchIdCgp0b19hZGRyZXNzGAEgASgJUgl0b0FkZHJlc3MSJQoOY2hhbm'
...
final $typed_data.Uint8List sudtTransferDescriptor =
    $convert.base64Decode('CgxTdWR0VHJhbnNmZXISHQoKdG9fYWRkcmVzcxgBIAEoCVIJdG9BZGRyZXNzEiUKDmNoYW5nZV'
...
final $typed_data.Uint8List daoDepositDescriptor =
    $convert.base64Decode('CgpEYW9EZXBvc2l0Eh0KCnRvX2FkZHJlc3MYASABKAlSCXRvQWRkcmVzcxIlCg5jaGFuZ2VfYW'
...
final $typed_data.Uint8List daoWithdrawPhase1Descriptor =
    $convert.base64Decode('ChFEYW9XaXRoZHJhd1BoYXNlMRI4CgxkZXBvc2l0X2NlbGwYASABKAsyFS5UVy5OZXJ2b3MuUH'
...
final $typed_data.Uint8List daoWithdrawPhase2Descriptor =
    $convert.base64Decode('ChFEYW9XaXRoZHJhd1BoYXNlMhI4CgxkZXBvc2l0X2NlbGwYASABKAsyFS5UVy5OZXJ2b3MuUH'
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSGQoIYnl0ZV9mZWUYASABKARSB2J5dGVGZWUSHwoLcHJpdmF0ZV9rZX'
...
final $typed_data.Uint8List cellDescriptor =
    $convert.base64Decode('CgRDZWxsEjYKCW91dF9wb2ludBgBIAEoCzIZLlRXLk5lcnZvcy5Qcm90by5PdXRQb2ludFIIb3'
...
final $typed_data.Uint8List signingOutputDescriptor =
    $convert.base64Decode('Cg1TaWduaW5nT3V0cHV0EikKEHRyYW5zYWN0aW9uX2pzb24YASABKAlSD3RyYW5zYWN0aW9uSn'
