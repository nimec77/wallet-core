...
class Timestamp extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Timestamp',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Hedera.Proto'), createEmptyInstance: create)
...
class TransactionID extends $pb.GeneratedMessage {
  ...
  factory TransactionID.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TransactionID.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransactionID',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Hedera.Proto'), createEmptyInstance: create)
  ...
  TransactionID copyWith(void Function(TransactionID) updates) =>
      super.copyWith((message) => updates(message as TransactionID)) as TransactionID;
...
class TransactionBody extends $pb.GeneratedMessage {
  ...
  factory TransactionBody.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TransactionBody.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TransactionBody',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Hedera.Proto'), createEmptyInstance: create)
    ..oo(0, [6])
    ...
    ..a<$fixnum.Int64>(3, _omitFieldNames ? '' : 'transactionFee', $pb.PbFieldType.OU6,
  ...
  TransactionBody copyWith(void Function(TransactionBody) updates) =>
      super.copyWith((message) => updates(message as TransactionBody)) as TransactionBody;
  ...
  @$core.pragma('dart2js:noInline')
  static TransactionBody getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TransactionBody>(create);
