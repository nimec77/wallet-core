...
final $typed_data.Uint8List facetCutActionDescriptor =
    $convert.base64Decode('Cg5GYWNldEN1dEFjdGlvbhIHCgNBREQQABILCgdSRVBMQUNFEAESCgoGUkVNT1ZFEAI=');
...
final $typed_data.Uint8List contractAddressInputDescriptor =
    $convert.base64Decode('ChRDb250cmFjdEFkZHJlc3NJbnB1dBIfCgtlbnRyeV9wb2ludBgBIAEoCVIKZW50cnlQb2ludB'
...
final $typed_data.Uint8List facetCutDescriptor =
    $convert.base64Decode('CghGYWNldEN1dBIjCg1mYWNldF9hZGRyZXNzGAEgASgJUgxmYWNldEFkZHJlc3MSNQoGYWN0aW'
...
final $typed_data.Uint8List diamondCutInputDescriptor =
    $convert.base64Decode('Cg9EaWFtb25kQ3V0SW5wdXQSNgoKZmFjZXRfY3V0cxgBIAMoCzIXLlRXLkJhcnouUHJvdG8uRm'
