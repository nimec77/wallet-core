...
final $typed_data.Uint8List transferMessageDescriptor =
    $convert.base64Decode('Cg9UcmFuc2Zlck1lc3NhZ2USDgoCdG8YASABKAlSAnRvEhYKBmFtb3VudBgCIAEoBFIGYW1vdW'
        '50');
...
final $typed_data.Uint8List structTagDescriptor =
    $convert.base64Decode('CglTdHJ1Y3RUYWcSJwoPYWNjb3VudF9hZGRyZXNzGAEgASgJUg5hY2NvdW50QWRkcmVzcxIWCg'
...
final $typed_data.Uint8List tokenTransferMessageDescriptor =
    $convert.base64Decode('ChRUb2tlblRyYW5zZmVyTWVzc2FnZRIOCgJ0bxgBIAEoCVICdG8SFgoGYW1vdW50GAIgASgEUg'
...
final $typed_data.Uint8List tokenTransferCoinsMessageDescriptor =
    $convert.base64Decode('ChlUb2tlblRyYW5zZmVyQ29pbnNNZXNzYWdlEg4KAnRvGAEgASgJUgJ0bxIWCgZhbW91bnQYAi'
...
final $typed_data.Uint8List managedTokensRegisterMessageDescriptor =
    $convert.base64Decode('ChxNYW5hZ2VkVG9rZW5zUmVnaXN0ZXJNZXNzYWdlEjUKCGZ1bmN0aW9uGAEgASgLMhkuVFcuQX'
...
final $typed_data.Uint8List createAccountMessageDescriptor =
    $convert.base64Decode('ChRDcmVhdGVBY2NvdW50TWVzc2FnZRIZCghhdXRoX2tleRgBIAEoCVIHYXV0aEtleQ==');
...
final $typed_data.Uint8List offerNftMessageDescriptor =
    $convert.base64Decode('Cg9PZmZlck5mdE1lc3NhZ2USGgoIcmVjZWl2ZXIYASABKAlSCHJlY2VpdmVyEhgKB2NyZWF0b3'
...
final $typed_data.Uint8List cancelOfferNftMessageDescriptor =
    $convert.base64Decode('ChVDYW5jZWxPZmZlck5mdE1lc3NhZ2USGgoIcmVjZWl2ZXIYASABKAlSCHJlY2VpdmVyEhgKB2'
...
final $typed_data.Uint8List claimNftMessageDescriptor =
    $convert.base64Decode('Cg9DbGFpbU5mdE1lc3NhZ2USFgoGc2VuZGVyGAEgASgJUgZzZW5kZXISGAoHY3JlYXRvchgCIA'
...
final $typed_data.Uint8List tortugaStakeDescriptor =
    $convert.base64Decode('CgxUb3J0dWdhU3Rha2USFgoGYW1vdW50GAEgASgEUgZhbW91bnQ=');
...
final $typed_data.Uint8List tortugaUnstakeDescriptor =
    $convert.base64Decode('Cg5Ub3J0dWdhVW5zdGFrZRIWCgZhbW91bnQYASABKARSBmFtb3VudA==');
...
final $typed_data.Uint8List liquidStakingDescriptor =
    $convert.base64Decode('Cg1MaXF1aWRTdGFraW5nEjQKFnNtYXJ0X2NvbnRyYWN0X2FkZHJlc3MYASABKAlSFHNtYXJ0Q2'
...
final $typed_data.Uint8List nftMessageDescriptor =
    $convert.base64Decode('CgpOZnRNZXNzYWdlEj4KCW9mZmVyX25mdBgBIAEoCzIfLlRXLkFwdG9zLlByb3RvLk9mZmVyTm'
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSFgoGc2VuZGVyGAEgASgJUgZzZW5kZXISJwoPc2VxdWVuY2VfbnVtYm'
...
final $typed_data.Uint8List transactionAuthenticatorDescriptor =
    $convert.base64Decode('ChhUcmFuc2FjdGlvbkF1dGhlbnRpY2F0b3ISHAoJc2lnbmF0dXJlGAEgASgMUglzaWduYXR1cm'
...
final $typed_data.Uint8List signingOutputDescriptor =
    $convert.base64Decode('Cg1TaWduaW5nT3V0cHV0EhcKB3Jhd190eG4YASABKAxSBnJhd1R4bhJOCg1hdXRoZW50aWNhdG'
