...
final $typed_data.Uint8List publicKeyDescriptor =
    $convert.base64Decode('CglQdWJsaWNLZXkSGQoIa2V5X3R5cGUYASABKA1SB2tleVR5cGUSEgoEZGF0YRgCIAEoDFIEZG'
        'F0YQ==');
...
final $typed_data.Uint8List functionCallPermissionDescriptor =
    $convert.base64Decode('ChZGdW5jdGlvbkNhbGxQZXJtaXNzaW9uEhwKCWFsbG93YW5jZRgBIAEoDFIJYWxsb3dhbmNlEh'
...
final $typed_data.Uint8List accessKeyDescriptor =
    $convert.base64Decode('CglBY2Nlc3NLZXkSFAoFbm9uY2UYASABKARSBW5vbmNlEkwKDWZ1bmN0aW9uX2NhbGwYAiABKA'
...
final $typed_data.Uint8List functionCallDescriptor =
    $convert.base64Decode('CgxGdW5jdGlvbkNhbGwSHwoLbWV0aG9kX25hbWUYASABKAlSCm1ldGhvZE5hbWUSEgoEYXJncx'
...
final $typed_data.Uint8List stakeDescriptor =
    $convert.base64Decode('CgVTdGFrZRIUCgVzdGFrZRgBIAEoDFIFc3Rha2USNwoKcHVibGljX2tleRgCIAEoCzIYLlRXLk'
...
final $typed_data.Uint8List addKeyDescriptor =
    $convert.base64Decode('CgZBZGRLZXkSNwoKcHVibGljX2tleRgBIAEoCzIYLlRXLk5FQVIuUHJvdG8uUHVibGljS2V5Ug'
...
final $typed_data.Uint8List deleteKeyDescriptor =
    $convert.base64Decode('CglEZWxldGVLZXkSNwoKcHVibGljX2tleRgBIAEoCzIYLlRXLk5FQVIuUHJvdG8uUHVibGljS2'
        'V5UglwdWJsaWNLZXk=');
...
final $typed_data.Uint8List deleteAccountDescriptor =
    $convert.base64Decode('Cg1EZWxldGVBY2NvdW50EiUKDmJlbmVmaWNpYXJ5X2lkGAEgASgJUg1iZW5lZmljaWFyeUlk');
...
final $typed_data.Uint8List tokenTransferDescriptor =
    $convert.base64Decode('Cg1Ub2tlblRyYW5zZmVyEiEKDHRva2VuX2Ftb3VudBgBIAEoCVILdG9rZW5BbW91bnQSHwoLcm'
...
final $typed_data.Uint8List actionDescriptor =
    $convert.base64Decode('CgZBY3Rpb24SRQoOY3JlYXRlX2FjY291bnQYASABKAsyHC5UVy5ORUFSLlByb3RvLkNyZWF0ZU'
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSGwoJc2lnbmVyX2lkGAEgASgJUghzaWduZXJJZBIUCgVub25jZRgCIA'
...
final $typed_data.Uint8List signingOutputDescriptor =
    $convert.base64Decode('Cg1TaWduaW5nT3V0cHV0Ei0KEnNpZ25lZF90cmFuc2FjdGlvbhgBIAEoDFIRc2lnbmVkVHJhbn'
