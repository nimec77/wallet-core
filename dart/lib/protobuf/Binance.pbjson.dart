...
final $typed_data.Uint8List transactionDescriptor =
    $convert.base64Decode('CgtUcmFuc2FjdGlvbhISCgRtc2dzGAEgAygMUgRtc2dzEh4KCnNpZ25hdHVyZXMYAiADKAxSCn'
...
final $typed_data.Uint8List signatureDescriptor =
    $convert.base64Decode('CglTaWduYXR1cmUSFwoHcHViX2tleRgBIAEoDFIGcHViS2V5EhwKCXNpZ25hdHVyZRgCIAEoDF'
...
final $typed_data.Uint8List tradeOrderDescriptor =
    $convert.base64Decode('CgpUcmFkZU9yZGVyEhYKBnNlbmRlchgBIAEoDFIGc2VuZGVyEg4KAmlkGAIgASgJUgJpZBIWCg'
...
final $typed_data.Uint8List cancelTradeOrderDescriptor =
    $convert.base64Decode('ChBDYW5jZWxUcmFkZU9yZGVyEhYKBnNlbmRlchgBIAEoDFIGc2VuZGVyEhYKBnN5bWJvbBgCIA'
...
final $typed_data.Uint8List sendOrderDescriptor =
    $convert.base64Decode('CglTZW5kT3JkZXISOQoGaW5wdXRzGAEgAygLMiEuVFcuQmluYW5jZS5Qcm90by5TZW5kT3JkZX'
...
final $typed_data.Uint8List tokenIssueOrderDescriptor =
    $convert.base64Decode('Cg9Ub2tlbklzc3VlT3JkZXISEgoEZnJvbRgBIAEoDFIEZnJvbRISCgRuYW1lGAIgASgJUgRuYW'
...
final $typed_data.Uint8List tokenMintOrderDescriptor =
    $convert.base64Decode('Cg5Ub2tlbk1pbnRPcmRlchISCgRmcm9tGAEgASgMUgRmcm9tEhYKBnN5bWJvbBgCIAEoCVIGc3'
...
final $typed_data.Uint8List tokenBurnOrderDescriptor =
    $convert.base64Decode('Cg5Ub2tlbkJ1cm5PcmRlchISCgRmcm9tGAEgASgMUgRmcm9tEhYKBnN5bWJvbBgCIAEoCVIGc3'
        'ltYm9sEhYKBmFtb3VudBgDIAEoA1IGYW1vdW50');
...
final $typed_data.Uint8List tokenFreezeOrderDescriptor =
    $convert.base64Decode('ChBUb2tlbkZyZWV6ZU9yZGVyEhIKBGZyb20YASABKAxSBGZyb20SFgoGc3ltYm9sGAIgASgJUg'
...
final $typed_data.Uint8List tokenUnfreezeOrderDescriptor =
    $convert.base64Decode('ChJUb2tlblVuZnJlZXplT3JkZXISEgoEZnJvbRgBIAEoDFIEZnJvbRIWCgZzeW1ib2wYAiABKA'
...
final $typed_data.Uint8List hTLTOrderDescriptor =
    $convert.base64Decode('CglIVExUT3JkZXISEgoEZnJvbRgBIAEoDFIEZnJvbRIOCgJ0bxgCIAEoDFICdG8SMgoVcmVjaX'
...
final $typed_data.Uint8List depositHTLTOrderDescriptor =
    $convert.base64Decode('ChBEZXBvc2l0SFRMVE9yZGVyEhIKBGZyb20YASABKAxSBGZyb20SOQoGYW1vdW50GAIgAygLMi'
...
final $typed_data.Uint8List claimHTLOrderDescriptor =
    $convert.base64Decode('Cg1DbGFpbUhUTE9yZGVyEhIKBGZyb20YASABKAxSBGZyb20SFwoHc3dhcF9pZBgCIAEoDFIGc3'
...
final $typed_data.Uint8List refundHTLTOrderDescriptor =
    $convert.base64Decode('Cg9SZWZ1bmRIVExUT3JkZXISEgoEZnJvbRgBIAEoDFIEZnJvbRIXCgdzd2FwX2lkGAIgASgMUg'
        'Zzd2FwSWQ=');
...
final $typed_data.Uint8List transferOutDescriptor =
    $convert.base64Decode('CgtUcmFuc2Zlck91dBISCgRmcm9tGAEgASgMUgRmcm9tEg4KAnRvGAIgASgMUgJ0bxI5CgZhbW'
...
final $typed_data.Uint8List sideChainDelegateDescriptor =
    $convert.base64Decode('ChFTaWRlQ2hhaW5EZWxlZ2F0ZRIlCg5kZWxlZ2F0b3JfYWRkchgBIAEoDFINZGVsZWdhdG9yQW'
...
final $typed_data.Uint8List sideChainRedelegateDescriptor =
    $convert.base64Decode('ChNTaWRlQ2hhaW5SZWRlbGVnYXRlEiUKDmRlbGVnYXRvcl9hZGRyGAEgASgMUg1kZWxlZ2F0b3'
...
final $typed_data.Uint8List sideChainUndelegateDescriptor =
    $convert.base64Decode('ChNTaWRlQ2hhaW5VbmRlbGVnYXRlEiUKDmRlbGVnYXRvcl9hZGRyGAEgASgMUg1kZWxlZ2F0b3'
...
final $typed_data.Uint8List sideChainStakeMigrationDescriptor =
    $convert.base64Decode('ChdTaWRlQ2hhaW5TdGFrZU1pZ3JhdGlvbhIsChJ2YWxpZGF0b3Jfc3JjX2FkZHIYASABKAxSEH'
...
final $typed_data.Uint8List timeLockOrderDescriptor =
    $convert.base64Decode('Cg1UaW1lTG9ja09yZGVyEiEKDGZyb21fYWRkcmVzcxgBIAEoDFILZnJvbUFkZHJlc3MSIAoLZG'
...
final $typed_data.Uint8List timeRelockOrderDescriptor =
    $convert.base64Decode('Cg9UaW1lUmVsb2NrT3JkZXISIQoMZnJvbV9hZGRyZXNzGAEgASgMUgtmcm9tQWRkcmVzcxIOCg'
...
final $typed_data.Uint8List timeUnlockOrderDescriptor =
    $convert.base64Decode('Cg9UaW1lVW5sb2NrT3JkZXISIQoMZnJvbV9hZGRyZXNzGAEgASgMUgtmcm9tQWRkcmVzcxIOCg'
        'JpZBgCIAEoA1ICaWQ=');
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSGQoIY2hhaW5faWQYASABKAlSB2NoYWluSWQSJQoOYWNjb3VudF9udW'
...
final $typed_data.Uint8List signingOutputDescriptor =
    $convert.base64Decode('Cg1TaWduaW5nT3V0cHV0EhgKB2VuY29kZWQYASABKAxSB2VuY29kZWQSMwoFZXJyb3IYAiABKA'
