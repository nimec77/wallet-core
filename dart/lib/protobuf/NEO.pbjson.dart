...
final $typed_data.Uint8List transactionInputDescriptor =
    $convert.base64Decode('ChBUcmFuc2FjdGlvbklucHV0EhsKCXByZXZfaGFzaBgBIAEoDFIIcHJldkhhc2gSHQoKcHJldl'
...
final $typed_data.Uint8List outputAddressDescriptor =
    $convert.base64Decode('Cg1PdXRwdXRBZGRyZXNzEhYKBmFtb3VudBgBIAEoElIGYW1vdW50Eh0KCnRvX2FkZHJlc3MYAi'
...
final $typed_data.Uint8List transactionOutputDescriptor =
    $convert.base64Decode('ChFUcmFuc2FjdGlvbk91dHB1dBIZCghhc3NldF9pZBgBIAEoCVIHYXNzZXRJZBIWCgZhbW91bn'
...
final $typed_data.Uint8List transactionDescriptor =
    $convert.base64Decode('CgtUcmFuc2FjdGlvbhJNCg1uZXA1X3RyYW5zZmVyGAEgASgLMiYuVFcuTkVPLlByb3RvLlRyYW'
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSNgoGaW5wdXRzGAEgAygLMh4uVFcuTkVPLlByb3RvLlRyYW5zYWN0aW'
...
final $typed_data.Uint8List transactionOutputPlanDescriptor =
    $convert.base64Decode('ChVUcmFuc2FjdGlvbk91dHB1dFBsYW4SFgoGYW1vdW50GAEgASgDUgZhbW91bnQSKQoQYXZhaW'
...
final $typed_data.Uint8List transactionAttributePlanDescriptor =
    $convert.base64Decode('ChhUcmFuc2FjdGlvbkF0dHJpYnV0ZVBsYW4SFAoFdXNhZ2UYASABKAVSBXVzYWdlEhIKBGRhdG'
        'EYAiABKAxSBGRhdGE=');
...
final $typed_data.Uint8List transactionPlanDescriptor =
    $convert.base64Decode('Cg9UcmFuc2FjdGlvblBsYW4SPQoHb3V0cHV0cxgBIAMoCzIjLlRXLk5FTy5Qcm90by5UcmFuc2'
