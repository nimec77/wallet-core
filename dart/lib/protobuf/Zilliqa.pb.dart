...
class Transaction_Transfer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Transaction.Transfer',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Zilliqa.Proto'), createEmptyInstance: create)
...
class Transaction_Raw extends $pb.GeneratedMessage {
  ...
  factory Transaction_Raw.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Transaction_Raw.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Transaction.Raw',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.Zilliqa.Proto'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'amount', $pb.PbFieldType.OY)
  ...
  Transaction_Raw copyWith(void Function(Transaction_Raw) updates) =>
      super.copyWith((message) => updates(message as Transaction_Raw)) as Transaction_Raw;
  ...
  @$core.pragma('dart2js:noInline')
  static Transaction_Raw getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Transaction_Raw>(create);
