...
final $typed_data.Uint8List transferDescriptor =
    $convert.base64Decode('CghUcmFuc2ZlchIWCgZhbW91bnQYASABKAlSBmFtb3VudBIcCglyZWNpcGllbnQYAiABKAlSCX'
...
final $typed_data.Uint8List stakingDescriptor =
    $convert.base64Decode('CgdTdGFraW5nEkIKC3N0YWtlQ3JlYXRlGAEgASgLMh4uVFcuSW9UZVguUHJvdG8uU3Rha2luZy'
...
final $typed_data.Uint8List contractCallDescriptor =
    $convert.base64Decode('CgxDb250cmFjdENhbGwSFgoGYW1vdW50GAEgASgJUgZhbW91bnQSGgoIY29udHJhY3QYAiABKA'
...
final $typed_data.Uint8List signingOutputDescriptor =
    $convert.base64Decode('Cg1TaWduaW5nT3V0cHV0EhgKB2VuY29kZWQYASABKAxSB2VuY29kZWQSEgoEaGFzaBgCIAEoDF'
...
final $typed_data.Uint8List actionCoreDescriptor =
    $convert.base64Decode('CgpBY3Rpb25Db3JlEhgKB3ZlcnNpb24YASABKA1SB3ZlcnNpb24SFAoFbm9uY2UYAiABKARSBW'
...
final $typed_data.Uint8List actionDescriptor =
    $convert.base64Decode('CgZBY3Rpb24SLgoEY29yZRgBIAEoCzIaLlRXLklvVGVYLlByb3RvLkFjdGlvbkNvcmVSBGNvcm'
