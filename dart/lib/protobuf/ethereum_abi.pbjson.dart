...
final $typed_data.Uint8List abiErrorDescriptor =
    $convert.base64Decode('CghBYmlFcnJvchIGCgJPSxAAEhIKDkVycm9yX2ludGVybmFsEAESFgoSRXJyb3JfYWJpX21pc2'
...
final $typed_data.Uint8List boolTypeDescriptor = $convert.base64Decode('CghCb29sVHlwZQ==');
...
final $typed_data.Uint8List stringTypeDescriptor = $convert.base64Decode('CgpTdHJpbmdUeXBl');
...
final $typed_data.Uint8List addressTypeDescriptor = $convert.base64Decode('CgtBZGRyZXNzVHlwZQ==');
...
final $typed_data.Uint8List arrayTypeDescriptor =
    $convert.base64Decode('CglBcnJheVR5cGUSQgoMZWxlbWVudF90eXBlGAEgASgLMh8uVFcuRXRoZXJldW1BYmkuUHJvdG'
...
final $typed_data.Uint8List fixedArrayTypeDescriptor =
    $convert.base64Decode('Cg5GaXhlZEFycmF5VHlwZRISCgRzaXplGAEgASgEUgRzaXplEkIKDGVsZW1lbnRfdHlwZRgCIA'
...
final $typed_data.Uint8List byteArrayTypeDescriptor = $convert.base64Decode('Cg1CeXRlQXJyYXlUeXBl');
...
final $typed_data.Uint8List byteArrayFixTypeDescriptor =
    $convert.base64Decode('ChBCeXRlQXJyYXlGaXhUeXBlEhIKBHNpemUYASABKARSBHNpemU=');
...
final $typed_data.Uint8List tupleTypeDescriptor =
    $convert.base64Decode('CglUdXBsZVR5cGUSMwoGcGFyYW1zGAEgAygLMhsuVFcuRXRoZXJldW1BYmkuUHJvdG8uUGFyYW'
        '1SBnBhcmFtcw==');
...
final $typed_data.Uint8List paramDescriptor =
    $convert.base64Decode('CgVQYXJhbRISCgRuYW1lGAEgASgJUgRuYW1lEjUKBXBhcmFtGAIgASgLMh8uVFcuRXRoZXJldW'
...
final $typed_data.Uint8List paramTypeDescriptor =
    $convert.base64Decode('CglQYXJhbVR5cGUSOgoHYm9vbGVhbhgBIAEoCzIeLlRXLkV0aGVyZXVtQWJpLlByb3RvLkJvb2'
...
final $typed_data.Uint8List numberNParamDescriptor =
    $convert.base64Decode('CgxOdW1iZXJOUGFyYW0SEgoEYml0cxgBIAEoDVIEYml0cxIUCgV2YWx1ZRgCIAEoDFIFdmFsdW'
        'U=');
...
final $typed_data.Uint8List arrayParamDescriptor =
    $convert.base64Decode('CgpBcnJheVBhcmFtEkIKDGVsZW1lbnRfdHlwZRgBIAEoCzIfLlRXLkV0aGVyZXVtQWJpLlByb3'
...
final $typed_data.Uint8List tupleParamDescriptor =
    $convert.base64Decode('CgpUdXBsZVBhcmFtEjMKBnBhcmFtcxgBIAMoCzIbLlRXLkV0aGVyZXVtQWJpLlByb3RvLlRva2'
        'VuUgZwYXJhbXM=');
...
final $typed_data.Uint8List tokenDescriptor =
    $convert.base64Decode('CgVUb2tlbhISCgRuYW1lGAEgASgJUgRuYW1lEhoKB2Jvb2xlYW4YAiABKAhIAFIHYm9vbGVhbh'
...
final $typed_data.Uint8List contractCallDecodingInputDescriptor =
    $convert.base64Decode('ChlDb250cmFjdENhbGxEZWNvZGluZ0lucHV0EhgKB2VuY29kZWQYASABKAxSB2VuY29kZWQSNQ'
...
final $typed_data.Uint8List contractCallDecodingOutputDescriptor =
    $convert.base64Decode('ChpDb250cmFjdENhbGxEZWNvZGluZ091dHB1dBIhCgxkZWNvZGVkX2pzb24YASABKAlSC2RlY2'
...
final $typed_data.Uint8List abiParamsDescriptor =
    $convert.base64Decode('CglBYmlQYXJhbXMSMwoGcGFyYW1zGAEgAygLMhsuVFcuRXRoZXJldW1BYmkuUHJvdG8uUGFyYW'
        '1SBnBhcmFtcw==');
...
final $typed_data.Uint8List paramsDecodingInputDescriptor =
    $convert.base64Decode('ChNQYXJhbXNEZWNvZGluZ0lucHV0EhgKB2VuY29kZWQYASABKAxSB2VuY29kZWQSGwoIYWJpX2'
...
final $typed_data.Uint8List paramsDecodingOutputDescriptor =
    $convert.base64Decode('ChRQYXJhbXNEZWNvZGluZ091dHB1dBIzCgZ0b2tlbnMYASADKAsyGy5UVy5FdGhlcmV1bUFiaS'
...
final $typed_data.Uint8List valueDecodingInputDescriptor =
    $convert.base64Decode('ChJWYWx1ZURlY29kaW5nSW5wdXQSGAoHZW5jb2RlZBgBIAEoDFIHZW5jb2RlZBIdCgpwYXJhbV'
...
final $typed_data.Uint8List valueDecodingOutputDescriptor =
    $convert.base64Decode('ChNWYWx1ZURlY29kaW5nT3V0cHV0EjEKBXRva2VuGAEgASgLMhsuVFcuRXRoZXJldW1BYmkuUH'
...
final $typed_data.Uint8List functionEncodingInputDescriptor =
    $convert.base64Decode('ChVGdW5jdGlvbkVuY29kaW5nSW5wdXQSIwoNZnVuY3Rpb25fbmFtZRgBIAEoCVIMZnVuY3Rpb2'
...
final $typed_data.Uint8List functionEncodingOutputDescriptor =
    $convert.base64Decode('ChZGdW5jdGlvbkVuY29kaW5nT3V0cHV0EiMKDWZ1bmN0aW9uX3R5cGUYASABKAlSDGZ1bmN0aW'
...
final $typed_data.Uint8List functionGetTypeInputDescriptor =
    $convert.base64Decode('ChRGdW5jdGlvbkdldFR5cGVJbnB1dBIjCg1mdW5jdGlvbl9uYW1lGAEgASgJUgxmdW5jdGlvbk'
