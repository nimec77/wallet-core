...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSRAoOb3BlcmF0aW9uX2xpc3QYASABKAsyHS5UVy5UZXpvcy5Qcm90by'
...
final $typed_data.Uint8List operationListDescriptor =
    $convert.base64Decode('Cg1PcGVyYXRpb25MaXN0EhYKBmJyYW5jaBgBIAEoCVIGYnJhbmNoEjkKCm9wZXJhdGlvbnMYAi'
...
final $typed_data.Uint8List operationDescriptor =
    $convert.base64Decode('CglPcGVyYXRpb24SGAoHY291bnRlchgBIAEoA1IHY291bnRlchIWCgZzb3VyY2UYAiABKAlSBn'
...
final $typed_data.Uint8List fA12ParametersDescriptor =
    $convert.base64Decode('Cg5GQTEyUGFyYW1ldGVycxIeCgplbnRyeXBvaW50GAEgASgJUgplbnRyeXBvaW50EhIKBGZyb2'
...
final $typed_data.Uint8List txsDescriptor =
    $convert.base64Decode('CgNUeHMSDgoCdG8YASABKAlSAnRvEhkKCHRva2VuX2lkGAIgASgJUgd0b2tlbklkEhYKBmFtb3'
...
final $typed_data.Uint8List txObjectDescriptor =
    $convert.base64Decode('CghUeE9iamVjdBISCgRmcm9tGAEgASgJUgRmcm9tEiUKA3R4cxgCIAMoCzITLlRXLlRlem9zLl'
        'Byb3RvLlR4c1IDdHhz');
...
final $typed_data.Uint8List fA2ParametersDescriptor =
    $convert.base64Decode('Cg1GQTJQYXJhbWV0ZXJzEh4KCmVudHJ5cG9pbnQYASABKAlSCmVudHJ5cG9pbnQSNwoKdHhzX2'
...
final $typed_data.Uint8List operationParametersDescriptor =
    $convert.base64Decode('ChNPcGVyYXRpb25QYXJhbWV0ZXJzEkkKD2ZhMTJfcGFyYW1ldGVycxgBIAEoCzIeLlRXLlRlem'
...
final $typed_data.Uint8List transactionOperationDataDescriptor =
    $convert.base64Decode('ChhUcmFuc2FjdGlvbk9wZXJhdGlvbkRhdGESIAoLZGVzdGluYXRpb24YASABKAlSC2Rlc3Rpbm'
...
final $typed_data.Uint8List revealOperationDataDescriptor =
    $convert.base64Decode('ChNSZXZlYWxPcGVyYXRpb25EYXRhEh0KCnB1YmxpY19rZXkYASABKAxSCXB1YmxpY0tleQ==');
...
final $typed_data.Uint8List delegationOperationDataDescriptor =
    $convert.base64Decode('ChdEZWxlZ2F0aW9uT3BlcmF0aW9uRGF0YRIaCghkZWxlZ2F0ZRgBIAEoCVIIZGVsZWdhdGU=');
