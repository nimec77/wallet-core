...
final $typed_data.Uint8List keyTypeDescriptor =
    $convert.base64Decode('CgdLZXlUeXBlEgoKBkxFR0FDWRAAEgwKCE1PREVSTksxEAESDAoITU9ERVJOUjEQAg==');
...
final $typed_data.Uint8List assetDescriptor =
    $convert.base64Decode('CgVBc3NldBIWCgZhbW91bnQYASABKANSBmFtb3VudBIaCghkZWNpbWFscxgCIAEoDVIIZGVjaW'
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSGQoIY2hhaW5faWQYASABKAxSB2NoYWluSWQSLAoScmVmZXJlbmNlX2'
...
final $typed_data.Uint8List signingOutputDescriptor =
    $convert.base64Decode('Cg1TaWduaW5nT3V0cHV0EiEKDGpzb25fZW5jb2RlZBgBIAEoCVILanNvbkVuY29kZWQSMwoFZX'
