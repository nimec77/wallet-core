...
final $typed_data.Uint8List algorithmDescriptor =
    $convert.base64Decode('CglBbGdvcml0aG0SCwoHVU5LTk9XThAAEg0KCVNFQ1AyNTZLMRABEgsKB0VEMjU1MTkQAg==');
...
final $typed_data.Uint8List actionDescriptor =
    $convert.base64Decode('CgZBY3Rpb24SGgoIY29udHJhY3QYASABKAlSCGNvbnRyYWN0Eh8KC2FjdGlvbl9uYW1lGAIgAS'
...
final $typed_data.Uint8List amountLimitDescriptor =
    $convert.base64Decode('CgtBbW91bnRMaW1pdBIUCgV0b2tlbhgBIAEoCVIFdG9rZW4SFAoFdmFsdWUYAiABKAlSBXZhbH'
        'Vl');
...
final $typed_data.Uint8List signatureDescriptor =
    $convert.base64Decode('CglTaWduYXR1cmUSNgoJYWxnb3JpdGhtGAEgASgOMhguVFcuSU9TVC5Qcm90by5BbGdvcml0aG'
...
final $typed_data.Uint8List transactionDescriptor =
    $convert.base64Decode('CgtUcmFuc2FjdGlvbhISCgR0aW1lGAEgASgDUgR0aW1lEh4KCmV4cGlyYXRpb24YAiABKANSCm'
...
final $typed_data.Uint8List accountInfoDescriptor =
    $convert.base64Decode('CgtBY2NvdW50SW5mbxISCgRuYW1lGAEgASgJUgRuYW1lEh0KCmFjdGl2ZV9rZXkYAiABKAxSCW'
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSNAoHYWNjb3VudBgBIAEoCzIaLlRXLklPU1QuUHJvdG8uQWNjb3VudE'
...
final $typed_data.Uint8List signingOutputDescriptor =
    $convert.base64Decode('Cg1TaWduaW5nT3V0cHV0EjwKC3RyYW5zYWN0aW9uGAEgASgLMhouVFcuSU9TVC5Qcm90by5Ucm'
