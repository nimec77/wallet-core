...
final $typed_data.Uint8List currencyAmountDescriptor =
    $convert.base64Decode('Cg5DdXJyZW5jeUFtb3VudBIaCghjdXJyZW5jeRgBIAEoCVIIY3VycmVuY3kSFAoFdmFsdWUYAi'
...
final $typed_data.Uint8List operationTrustSetDescriptor =
    $convert.base64Decode('ChFPcGVyYXRpb25UcnVzdFNldBJCCgxsaW1pdF9hbW91bnQYASABKAsyHy5UVy5SaXBwbGUuUH'
...
final $typed_data.Uint8List operationPaymentDescriptor =
    $convert.base64Decode('ChBPcGVyYXRpb25QYXltZW50EhgKBmFtb3VudBgBIAEoA0gAUgZhbW91bnQSSgoPY3VycmVuY3'
...
final $typed_data.Uint8List operationEscrowCreateDescriptor =
    $convert.base64Decode('ChVPcGVyYXRpb25Fc2Nyb3dDcmVhdGUSFgoGYW1vdW50GAEgASgDUgZhbW91bnQSIAoLZGVzdG'
...
final $typed_data.Uint8List operationEscrowCancelDescriptor =
    $convert.base64Decode('ChVPcGVyYXRpb25Fc2Nyb3dDYW5jZWwSFAoFb3duZXIYASABKAlSBW93bmVyEiUKDm9mZmVyX3'
...
final $typed_data.Uint8List operationEscrowFinishDescriptor =
    $convert.base64Decode('ChVPcGVyYXRpb25Fc2Nyb3dGaW5pc2gSFAoFb3duZXIYASABKAlSBW93bmVyEiUKDm9mZmVyX3'
...
final $typed_data.Uint8List operationNFTokenBurnDescriptor =
    $convert.base64Decode('ChRPcGVyYXRpb25ORlRva2VuQnVybhIdCgpuZnRva2VuX2lkGAEgASgMUgluZnRva2VuSWQ=');
...
final $typed_data.Uint8List operationNFTokenCreateOfferDescriptor =
    $convert.base64Decode('ChtPcGVyYXRpb25ORlRva2VuQ3JlYXRlT2ZmZXISHQoKbmZ0b2tlbl9pZBgBIAEoDFIJbmZ0b2'
...
final $typed_data.Uint8List operationNFTokenAcceptOfferDescriptor =
    $convert.base64Decode('ChtPcGVyYXRpb25ORlRva2VuQWNjZXB0T2ZmZXISHQoKc2VsbF9vZmZlchgBIAEoDFIJc2VsbE'
        '9mZmVy');
...
final $typed_data.Uint8List operationNFTokenCancelOfferDescriptor =
    $convert.base64Decode('ChtPcGVyYXRpb25ORlRva2VuQ2FuY2VsT2ZmZXISIQoMdG9rZW5fb2ZmZXJzGAEgAygMUgt0b2'
        'tlbk9mZmVycw==');
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSEAoDZmVlGAEgASgDUgNmZWUSGgoIc2VxdWVuY2UYAiABKAVSCHNlcX'
