...
class GenericAction extends $pb.GeneratedMessage {
  ...
  factory GenericAction.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GenericAction.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenericAction',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.MultiversX.Proto'), createEmptyInstance: create)
  ...
  GenericAction copyWith(void Function(GenericAction) updates) =>
      super.copyWith((message) => updates(message as GenericAction)) as GenericAction;
...
class EGLDTransfer extends $pb.GeneratedMessage {
  ...
  factory EGLDTransfer.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory EGLDTransfer.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EGLDTransfer',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.MultiversX.Proto'), createEmptyInstance: create)
    ..aOM<Accounts>(1, _omitFieldNames ? '' : 'accounts', subBuilder: Accounts.create)
  ...
  EGLDTransfer copyWith(void Function(EGLDTransfer) updates) =>
      super.copyWith((message) => updates(message as EGLDTransfer)) as EGLDTransfer;
...
class ESDTTransfer extends $pb.GeneratedMessage {
  ...
  factory ESDTTransfer.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ESDTTransfer.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ESDTTransfer',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.MultiversX.Proto'), createEmptyInstance: create)
    ..aOM<Accounts>(1, _omitFieldNames ? '' : 'accounts', subBuilder: Accounts.create)
  ...
  ESDTTransfer copyWith(void Function(ESDTTransfer) updates) =>
      super.copyWith((message) => updates(message as ESDTTransfer)) as ESDTTransfer;
...
class ESDTNFTTransfer extends $pb.GeneratedMessage {
  ...
  factory ESDTNFTTransfer.fromBuffer($core.List<$core.int> i,
      ...
      create()..mergeFromBuffer(i, r);
  factory ESDTNFTTransfer.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ESDTNFTTransfer',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.MultiversX.Proto'), createEmptyInstance: create)
    ..aOM<Accounts>(1, _omitFieldNames ? '' : 'accounts', subBuilder: Accounts.create)
  ...
  ESDTNFTTransfer copyWith(void Function(ESDTNFTTransfer) updates) =>
      super.copyWith((message) => updates(message as ESDTNFTTransfer)) as ESDTNFTTransfer;
  ...
  @$core.pragma('dart2js:noInline')
  static ESDTNFTTransfer getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ESDTNFTTransfer>(create);
...
class Accounts extends $pb.GeneratedMessage {
  ...
  Accounts._() : super();
  factory Accounts.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Accounts.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Accounts',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.MultiversX.Proto'), createEmptyInstance: create)
...
enum SigningInput_MessageOneof { genericAction, egldTransfer, esdtTransfer, esdtnftTransfer, notSet }
