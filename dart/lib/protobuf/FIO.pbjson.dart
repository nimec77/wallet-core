...
final $typed_data.Uint8List publicAddressDescriptor =
    $convert.base64Decode('Cg1QdWJsaWNBZGRyZXNzEh8KC2NvaW5fc3ltYm9sGAEgASgJUgpjb2luU3ltYm9sEhgKB2FkZH'
...
final $typed_data.Uint8List newFundsContentDescriptor =
    $convert.base64Decode('Cg9OZXdGdW5kc0NvbnRlbnQSMAoUcGF5ZWVfcHVibGljX2FkZHJlc3MYASABKAlSEnBheWVlUH'
...
final $typed_data.Uint8List actionDescriptor =
    $convert.base64Decode('CgZBY3Rpb24SagoccmVnaXN0ZXJfZmlvX2FkZHJlc3NfbWVzc2FnZRgBIAEoCzInLlRXLkZJTy'
...
final $typed_data.Uint8List chainParamsDescriptor =
    $convert.base64Decode('CgtDaGFpblBhcmFtcxIZCghjaGFpbl9pZBgBIAEoDFIHY2hhaW5JZBIqChFoZWFkX2Jsb2NrX2'
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSFgoGZXhwaXJ5GAEgASgNUgZleHBpcnkSPAoMY2hhaW5fcGFyYW1zGA'
