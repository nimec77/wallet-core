...
final $typed_data.Uint8List coinDescriptor =
    $convert.base64Decode('CgRDb2luEgcKA1BPTBAAEggKBEFUT00QARIHCgNCTkIQAhIHCgNBUFQQAxIHCgNFVEgQBA==');
...
final $typed_data.Uint8List blockchainDescriptor =
    $convert.base64Decode('CgpCbG9ja2NoYWluEgwKCEVUSEVSRVVNEAASCwoHUE9MWUdPThABEgoKBlNUUklERRACEgsKB0'
...
final $typed_data.Uint8List protocolDescriptor =
    $convert.base64Decode('CghQcm90b2NvbBILCgdTdHJhZGVyEAASCgoGU3RyaWRlEAESCwoHVG9ydHVnYRACEggKBExpZG'
        '8QAw==');
...
final $typed_data.Uint8List statusCodeDescriptor =
    $convert.base64Decode('CgpTdGF0dXNDb2RlEgYKAk9LEAASGAoURVJST1JfQUNUSU9OX05PVF9TRVQQARI3CjNFUlJPUl'
...
final $typed_data.Uint8List statusDescriptor =
    $convert.base64Decode('CgZTdGF0dXMSNgoEY29kZRgBIAEoDjIiLlRXLkxpcXVpZFN0YWtpbmcuUHJvdG8uU3RhdHVzQ2'
...
final $typed_data.Uint8List assetDescriptor =
    $convert.base64Decode('CgVBc3NldBJBCg1zdGFraW5nX3Rva2VuGAEgASgOMhwuVFcuTGlxdWlkU3Rha2luZy5Qcm90by'
...
final $typed_data.Uint8List stakeDescriptor =
    $convert.base64Decode('CgVTdGFrZRIzCgVhc3NldBgBIAEoCzIdLlRXLkxpcXVpZFN0YWtpbmcuUHJvdG8uQXNzZXRSBW'
...
final $typed_data.Uint8List unstakeDescriptor =
    $convert.base64Decode('CgdVbnN0YWtlEjMKBWFzc2V0GAEgASgLMh0uVFcuTGlxdWlkU3Rha2luZy5Qcm90by5Bc3NldF'
...
final $typed_data.Uint8List withdrawDescriptor =
    $convert.base64Decode('CghXaXRoZHJhdxIzCgVhc3NldBgBIAEoCzIdLlRXLkxpcXVpZFN0YWtpbmcuUHJvdG8uQXNzZX'
...
final $typed_data.Uint8List inputDescriptor =
    $convert.base64Decode('CgVJbnB1dBI1CgVzdGFrZRgBIAEoCzIdLlRXLkxpcXVpZFN0YWtpbmcuUHJvdG8uU3Rha2VIAF'
...
final $typed_data.Uint8List outputDescriptor =
    $convert.base64Decode('CgZPdXRwdXQSNgoGc3RhdHVzGAEgASgLMh4uVFcuTGlxdWlkU3Rha2luZy5Qcm90by5TdGF0dX'
