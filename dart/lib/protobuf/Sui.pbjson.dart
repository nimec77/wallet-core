...
final $typed_data.Uint8List objectRefDescriptor =
    $convert.base64Decode('CglPYmplY3RSZWYSGwoJb2JqZWN0X2lkGAEgASgJUghvYmplY3RJZBIYCgd2ZXJzaW9uGAIgAS'
...
final $typed_data.Uint8List amountDescriptor = $convert.base64Decode('CgZBbW91bnQSFgoGYW1vdW50GAEgASgEUgZhbW91bnQ=');
...
final $typed_data.Uint8List signDirectDescriptor =
    $convert.base64Decode('CgpTaWduRGlyZWN0EiYKD3Vuc2lnbmVkX3R4X21zZxgBIAEoCVINdW5zaWduZWRUeE1zZw==');
...
final $typed_data.Uint8List payDescriptor =
    $convert.base64Decode('CgNQYXkSOAoLaW5wdXRfY29pbnMYASADKAsyFy5UVy5TdWkuUHJvdG8uT2JqZWN0UmVmUgppbn'
...
final $typed_data.Uint8List paySuiDescriptor =
    $convert.base64Decode('CgZQYXlTdWkSOAoLaW5wdXRfY29pbnMYASADKAsyFy5UVy5TdWkuUHJvdG8uT2JqZWN0UmVmUg'
...
final $typed_data.Uint8List payAllSuiDescriptor =
    $convert.base64Decode('CglQYXlBbGxTdWkSOAoLaW5wdXRfY29pbnMYASADKAsyFy5UVy5TdWkuUHJvdG8uT2JqZWN0Um'
...
final $typed_data.Uint8List requestAddStakeDescriptor =
    $convert.base64Decode('Cg9SZXF1ZXN0QWRkU3Rha2USLQoFY29pbnMYASADKAsyFy5UVy5TdWkuUHJvdG8uT2JqZWN0Um'
...
final $typed_data.Uint8List requestWithdrawStakeDescriptor =
    $convert.base64Decode('ChRSZXF1ZXN0V2l0aGRyYXdTdGFrZRI2CgpzdGFrZWRfc3VpGAEgASgLMhcuVFcuU3VpLlByb3'
...
final $typed_data.Uint8List transferObjectDescriptor =
    $convert.base64Decode('Cg5UcmFuc2Zlck9iamVjdBIvCgZvYmplY3QYASABKAsyFy5UVy5TdWkuUHJvdG8uT2JqZWN0Um'
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSHwoLcHJpdmF0ZV9rZXkYASABKAxSCnByaXZhdGVLZXkSFgoGc2lnbm'
...
final $typed_data.Uint8List signingOutputDescriptor =
    $convert.base64Decode('Cg1TaWduaW5nT3V0cHV0Eh8KC3Vuc2lnbmVkX3R4GAEgASgJUgp1bnNpZ25lZFR4EhwKCXNpZ2'
