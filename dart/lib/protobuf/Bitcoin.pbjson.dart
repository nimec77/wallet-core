...
final $typed_data.Uint8List transactionVariantDescriptor =
    $convert.base64Decode('ChJUcmFuc2FjdGlvblZhcmlhbnQSCQoFUDJQS0gQABIKCgZQMldQS0gQARIPCgtQMlRSS0VZUE'
...
final $typed_data.Uint8List transactionDescriptor =
    $convert.base64Decode('CgtUcmFuc2FjdGlvbhIYCgd2ZXJzaW9uGAEgASgRUgd2ZXJzaW9uEhoKCGxvY2tUaW1lGAIgAS'
...
final $typed_data.Uint8List transactionInputDescriptor =
    $convert.base64Decode('ChBUcmFuc2FjdGlvbklucHV0EkIKDnByZXZpb3VzT3V0cHV0GAEgASgLMhouVFcuQml0Y29pbi'
...
final $typed_data.Uint8List outPointDescriptor =
    $convert.base64Decode('CghPdXRQb2ludBISCgRoYXNoGAEgASgMUgRoYXNoEhQKBWluZGV4GAIgASgNUgVpbmRleBIaCg'
...
final $typed_data.Uint8List transactionOutputDescriptor =
    $convert.base64Decode('ChFUcmFuc2FjdGlvbk91dHB1dBIUCgV2YWx1ZRgBIAEoA1IFdmFsdWUSFgoGc2NyaXB0GAIgAS'
...
final $typed_data.Uint8List unspentTransactionDescriptor =
    $convert.base64Decode('ChJVbnNwZW50VHJhbnNhY3Rpb24SNwoJb3V0X3BvaW50GAEgASgLMhouVFcuQml0Y29pbi5Qcm'
...
final $typed_data.Uint8List outputAddressDescriptor =
    $convert.base64Decode('Cg1PdXRwdXRBZGRyZXNzEh0KCnRvX2FkZHJlc3MYASABKAlSCXRvQWRkcmVzcxIWCgZhbW91bn'
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSGwoJaGFzaF90eXBlGAEgASgNUghoYXNoVHlwZRIWCgZhbW91bnQYAi'
...
final $typed_data.Uint8List transactionPlanDescriptor =
    $convert.base64Decode('Cg9UcmFuc2FjdGlvblBsYW4SFgoGYW1vdW50GAEgASgDUgZhbW91bnQSKQoQYXZhaWxhYmxlX2'
...
final $typed_data.Uint8List signingOutputDescriptor =
    $convert.base64Decode('Cg1TaWduaW5nT3V0cHV0Ej8KC3RyYW5zYWN0aW9uGAEgASgLMh0uVFcuQml0Y29pbi5Qcm90by'
...
final $typed_data.Uint8List hashPublicKeyDescriptor =
    $convert.base64Decode('Cg1IYXNoUHVibGljS2V5EhsKCWRhdGFfaGFzaBgBIAEoDFIIZGF0YUhhc2gSJgoPcHVibGljX2'
...
final $typed_data.Uint8List preSigningOutputDescriptor =
    $convert.base64Decode('ChBQcmVTaWduaW5nT3V0cHV0EkkKEGhhc2hfcHVibGljX2tleXMYASADKAsyHy5UVy5CaXRjb2'
