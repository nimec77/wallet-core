...
final $typed_data.Uint8List tokenProgramIdDescriptor =
    $convert.base64Decode('Cg5Ub2tlblByb2dyYW1JZBIQCgxUb2tlblByb2dyYW0QABIUChBUb2tlbjIwMjJQcm9ncmFtEA'
        'E=');
...
final $typed_data.Uint8List transferDescriptor =
    $convert.base64Decode('CghUcmFuc2ZlchIcCglyZWNpcGllbnQYASABKAlSCXJlY2lwaWVudBIUCgV2YWx1ZRgCIAEoBF'
...
final $typed_data.Uint8List delegateStakeDescriptor =
    $convert.base64Decode('Cg1EZWxlZ2F0ZVN0YWtlEikKEHZhbGlkYXRvcl9wdWJrZXkYASABKAlSD3ZhbGlkYXRvclB1Ym'
...
final $typed_data.Uint8List deactivateStakeDescriptor =
    $convert.base64Decode('Cg9EZWFjdGl2YXRlU3Rha2USIwoNc3Rha2VfYWNjb3VudBgBIAEoCVIMc3Rha2VBY2NvdW50');
...
final $typed_data.Uint8List deactivateAllStakeDescriptor =
    $convert.base64Decode('ChJEZWFjdGl2YXRlQWxsU3Rha2USJQoOc3Rha2VfYWNjb3VudHMYASADKAlSDXN0YWtlQWNjb3'
        'VudHM=');
...
final $typed_data.Uint8List withdrawStakeDescriptor =
    $convert.base64Decode('Cg1XaXRoZHJhd1N0YWtlEiMKDXN0YWtlX2FjY291bnQYASABKAlSDHN0YWtlQWNjb3VudBIUCg'
...
final $typed_data.Uint8List stakeAccountValueDescriptor =
    $convert.base64Decode('ChFTdGFrZUFjY291bnRWYWx1ZRIjCg1zdGFrZV9hY2NvdW50GAEgASgJUgxzdGFrZUFjY291bn'
...
final $typed_data.Uint8List withdrawAllStakeDescriptor =
    $convert.base64Decode('ChBXaXRoZHJhd0FsbFN0YWtlEkkKDnN0YWtlX2FjY291bnRzGAEgAygLMiIuVFcuU29sYW5hLl'
...
final $typed_data.Uint8List createTokenAccountDescriptor =
    $convert.base64Decode('ChJDcmVhdGVUb2tlbkFjY291bnQSIQoMbWFpbl9hZGRyZXNzGAEgASgJUgttYWluQWRkcmVzcx'
...
final $typed_data.Uint8List tokenTransferDescriptor =
    $convert.base64Decode('Cg1Ub2tlblRyYW5zZmVyEiwKEnRva2VuX21pbnRfYWRkcmVzcxgBIAEoCVIQdG9rZW5NaW50QW'
...
final $typed_data.Uint8List createAndTransferTokenDescriptor =
    $convert.base64Decode('ChZDcmVhdGVBbmRUcmFuc2ZlclRva2VuEjQKFnJlY2lwaWVudF9tYWluX2FkZHJlc3MYASABKA'
...
final $typed_data.Uint8List createNonceAccountDescriptor =
    $convert.base64Decode('ChJDcmVhdGVOb25jZUFjY291bnQSIwoNbm9uY2VfYWNjb3VudBgBIAEoCVIMbm9uY2VBY2NvdW'
...
final $typed_data.Uint8List withdrawNonceAccountDescriptor =
    $convert.base64Decode('ChRXaXRoZHJhd05vbmNlQWNjb3VudBIjCg1ub25jZV9hY2NvdW50GAEgASgJUgxub25jZUFjY2'
...
final $typed_data.Uint8List advanceNonceAccountDescriptor =
    $convert.base64Decode('ChNBZHZhbmNlTm9uY2VBY2NvdW50EiMKDW5vbmNlX2FjY291bnQYASABKAlSDG5vbmNlQWNjb3'
        'VudA==');
...
final $typed_data.Uint8List pubkeySignatureDescriptor =
    $convert.base64Decode('Cg9QdWJrZXlTaWduYXR1cmUSFgoGcHVia2V5GAEgASgJUgZwdWJrZXkSHAoJc2lnbmF0dXJlGA'
...
final $typed_data.Uint8List rawMessageDescriptor =
    $convert.base64Decode('CgpSYXdNZXNzYWdlEkAKCnNpZ25hdHVyZXMYASADKAsyIC5UVy5Tb2xhbmEuUHJvdG8uUHVia2'
...
final $typed_data.Uint8List decodingTransactionOutputDescriptor =
    $convert.base64Decode('ChlEZWNvZGluZ1RyYW5zYWN0aW9uT3V0cHV0Ej0KC3RyYW5zYWN0aW9uGAEgASgLMhsuVFcuU2'
...
final $typed_data.Uint8List priorityFeePriceDescriptor =
    $convert.base64Decode('ChBQcmlvcml0eUZlZVByaWNlEhQKBXByaWNlGAEgASgEUgVwcmljZQ==');
...
final $typed_data.Uint8List priorityFeeLimitDescriptor =
    $convert.base64Decode('ChBQcmlvcml0eUZlZUxpbWl0EhQKBWxpbWl0GAIgASgNUgVsaW1pdA==');
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSHwoLcHJpdmF0ZV9rZXkYASABKAxSCnByaXZhdGVLZXkSKQoQcmVjZW'
...
final $typed_data.Uint8List signingOutputDescriptor =
    $convert.base64Decode('Cg1TaWduaW5nT3V0cHV0EhgKB2VuY29kZWQYASABKAlSB2VuY29kZWQSMwoFZXJyb3IYAiABKA'
...
final $typed_data.Uint8List preSigningOutputDescriptor =
    $convert.base64Decode('ChBQcmVTaWduaW5nT3V0cHV0EhgKB3NpZ25lcnMYASADKAxSB3NpZ25lcnMSEgoEZGF0YRgCIA'
