...
final $typed_data.Uint8List transactionCoinFromDescriptor =
    $convert.base64Decode('ChNUcmFuc2FjdGlvbkNvaW5Gcm9tEiEKDGZyb21fYWRkcmVzcxgBIAEoCVILZnJvbUFkZHJlc3'
...
final $typed_data.Uint8List transactionCoinToDescriptor =
    $convert.base64Decode('ChFUcmFuc2FjdGlvbkNvaW5UbxIdCgp0b19hZGRyZXNzGAEgASgJUgl0b0FkZHJlc3MSJQoOYX'
...
final $typed_data.Uint8List signatureDescriptor =
    $convert.base64Decode('CglTaWduYXR1cmUSGQoIcGtleV9sZW4YASABKA1SB3BrZXlMZW4SHQoKcHVibGljX2tleRgCIA'
...
final $typed_data.Uint8List transactionDescriptor =
    $convert.base64Decode('CgtUcmFuc2FjdGlvbhISCgR0eXBlGAEgASgNUgR0eXBlEhwKCXRpbWVzdGFtcBgCIAEoDVIJdG'
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSHwoLcHJpdmF0ZV9rZXkYASABKAxSCnByaXZhdGVLZXkSEgoEZnJvbR'
