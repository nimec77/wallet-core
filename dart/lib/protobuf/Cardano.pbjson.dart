...
final $typed_data.Uint8List outPointDescriptor =
    $convert.base64Decode('CghPdXRQb2ludBIXCgd0eF9oYXNoGAEgASgMUgZ0eEhhc2gSIQoMb3V0cHV0X2luZGV4GAIgAS'
...
final $typed_data.Uint8List tokenAmountDescriptor =
    $convert.base64Decode('CgtUb2tlbkFtb3VudBIbCglwb2xpY3lfaWQYASABKAlSCHBvbGljeUlkEh0KCmFzc2V0X25hbW'
...
final $typed_data.Uint8List txInputDescriptor =
    $convert.base64Decode('CgdUeElucHV0EjcKCW91dF9wb2ludBgBIAEoCzIaLlRXLkNhcmRhbm8uUHJvdG8uT3V0UG9pbn'
...
final $typed_data.Uint8List txOutputDescriptor =
    $convert.base64Decode('CghUeE91dHB1dBIYCgdhZGRyZXNzGAEgASgJUgdhZGRyZXNzEhYKBmFtb3VudBgCIAEoBFIGYW'
...
final $typed_data.Uint8List tokenBundleDescriptor =
    $convert.base64Decode('CgtUb2tlbkJ1bmRsZRIzCgV0b2tlbhgBIAMoCzIdLlRXLkNhcmRhbm8uUHJvdG8uVG9rZW5BbW'
        '91bnRSBXRva2Vu');
...
final $typed_data.Uint8List transferDescriptor =
    $convert.base64Decode('CghUcmFuc2ZlchIdCgp0b19hZGRyZXNzGAEgASgJUgl0b0FkZHJlc3MSJQoOY2hhbmdlX2FkZH'
...
final $typed_data.Uint8List registerStakingKeyDescriptor =
    $convert.base64Decode('ChJSZWdpc3RlclN0YWtpbmdLZXkSJwoPc3Rha2luZ19hZGRyZXNzGAEgASgJUg5zdGFraW5nQW'
...
final $typed_data.Uint8List deregisterStakingKeyDescriptor =
    $convert.base64Decode('ChREZXJlZ2lzdGVyU3Rha2luZ0tleRInCg9zdGFraW5nX2FkZHJlc3MYASABKAlSDnN0YWtpbm'
...
final $typed_data.Uint8List delegateDescriptor =
    $convert.base64Decode('CghEZWxlZ2F0ZRInCg9zdGFraW5nX2FkZHJlc3MYASABKAlSDnN0YWtpbmdBZGRyZXNzEhcKB3'
...
final $typed_data.Uint8List withdrawDescriptor =
    $convert.base64Decode('CghXaXRoZHJhdxInCg9zdGFraW5nX2FkZHJlc3MYASABKAlSDnN0YWtpbmdBZGRyZXNzEicKD3'
...
final $typed_data.Uint8List transactionPlanDescriptor =
    $convert.base64Decode('Cg9UcmFuc2FjdGlvblBsYW4SKQoQYXZhaWxhYmxlX2Ftb3VudBgBIAEoBFIPYXZhaWxhYmxlQW'
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSLwoFdXR4b3MYASADKAsyGS5UVy5DYXJkYW5vLlByb3RvLlR4SW5wdX'
...
final $typed_data.Uint8List signingOutputDescriptor =
    $convert.base64Decode('Cg1TaWduaW5nT3V0cHV0EhgKB2VuY29kZWQYASABKAxSB2VuY29kZWQSEwoFdHhfaWQYAiABKA'
