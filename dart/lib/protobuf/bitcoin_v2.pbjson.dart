...
final $typed_data.Uint8List inputSelectorDescriptor =
    $convert.base64Decode('Cg1JbnB1dFNlbGVjdG9yEhMKD1NlbGVjdEFzY2VuZGluZxAAEhEKDVNlbGVjdEluT3JkZXIQAR'
...
final $typed_data.Uint8List transactionVersionDescriptor =
    $convert.base64Decode('ChJUcmFuc2FjdGlvblZlcnNpb24SDgoKVXNlRGVmYXVsdBAAEgYKAlYxEAESBgoCVjIQAg==');
...
final $typed_data.Uint8List publicKeyOrHashDescriptor =
    $convert.base64Decode('Cg9QdWJsaWNLZXlPckhhc2gSGAoGcHVia2V5GAEgASgMSABSBnB1YmtleRIUCgRoYXNoGAIgAS'
...
final $typed_data.Uint8List outPointDescriptor =
    $convert.base64Decode('CghPdXRQb2ludBISCgRoYXNoGAEgASgMUgRoYXNoEhIKBHZvdXQYAiABKA1SBHZvdXQ=');
...
final $typed_data.Uint8List inputDescriptor =
    $convert.base64Decode('CgVJbnB1dBI5CglvdXRfcG9pbnQYASABKAsyHC5UVy5CaXRjb2luVjIuUHJvdG8uT3V0UG9pbn'
...
final $typed_data.Uint8List outputDescriptor =
    $convert.base64Decode('CgZPdXRwdXQSFAoFdmFsdWUYASABKANSBXZhbHVlEkQKB2J1aWxkZXIYAiABKAsyKC5UVy5CaX'
...
final $typed_data.Uint8List chainInfoDescriptor =
    $convert.base64Decode('CglDaGFpbkluZm8SIQoMcDJwa2hfcHJlZml4GAEgASgNUgtwMnBraFByZWZpeBIfCgtwMnNoX3'
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSQAoHdmVyc2lvbhgBIAEoDjImLlRXLkJpdGNvaW5WMi5Qcm90by5Ucm'
...
final $typed_data.Uint8List transactionDescriptor =
    $convert.base64Decode('CgtUcmFuc2FjdGlvbhIYCgd2ZXJzaW9uGAEgASgFUgd2ZXJzaW9uEhsKCWxvY2tfdGltZRgCIA'
...
final $typed_data.Uint8List transactionPlanDescriptor =
    $convert.base64Decode('Cg9UcmFuc2FjdGlvblBsYW4SMwoFZXJyb3IYASABKA4yHS5UVy5Db21tb24uUHJvdG8uU2lnbm'
...
final $typed_data.Uint8List preSigningOutputDescriptor =
    $convert.base64Decode('ChBQcmVTaWduaW5nT3V0cHV0EjMKBWVycm9yGAEgASgOMh0uVFcuQ29tbW9uLlByb3RvLlNpZ2'
...
final $typed_data.Uint8List signingOutputDescriptor =
    $convert.base64Decode('Cg1TaWduaW5nT3V0cHV0EjMKBWVycm9yGAEgASgOMh0uVFcuQ29tbW9uLlByb3RvLlNpZ25pbm'
