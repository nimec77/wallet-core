...
final $typed_data.Uint8List transferContractDescriptor =
    $convert.base64Decode('ChBUcmFuc2ZlckNvbnRyYWN0EiMKDW93bmVyX2FkZHJlc3MYASABKAlSDG93bmVyQWRkcmVzcx'
...
final $typed_data.Uint8List transferAssetContractDescriptor =
    $convert.base64Decode('ChVUcmFuc2ZlckFzc2V0Q29udHJhY3QSHQoKYXNzZXRfbmFtZRgBIAEoCVIJYXNzZXROYW1lEi'
...
final $typed_data.Uint8List transferTRC20ContractDescriptor =
    $convert.base64Decode('ChVUcmFuc2ZlclRSQzIwQ29udHJhY3QSKQoQY29udHJhY3RfYWRkcmVzcxgBIAEoCVIPY29udH'
...
final $typed_data.Uint8List freezeBalanceContractDescriptor =
    $convert.base64Decode('ChVGcmVlemVCYWxhbmNlQ29udHJhY3QSIwoNb3duZXJfYWRkcmVzcxgBIAEoCVIMb3duZXJBZG'
...
final $typed_data.Uint8List freezeBalanceV2ContractDescriptor =
    $convert.base64Decode('ChdGcmVlemVCYWxhbmNlVjJDb250cmFjdBIjCg1vd25lcl9hZGRyZXNzGAEgASgJUgxvd25lck'
...
final $typed_data.Uint8List unfreezeBalanceV2ContractDescriptor =
    $convert.base64Decode('ChlVbmZyZWV6ZUJhbGFuY2VWMkNvbnRyYWN0EiMKDW93bmVyX2FkZHJlc3MYASABKAlSDG93bm'
...
final $typed_data.Uint8List withdrawExpireUnfreezeContractDescriptor =
    $convert.base64Decode('Ch5XaXRoZHJhd0V4cGlyZVVuZnJlZXplQ29udHJhY3QSIwoNb3duZXJfYWRkcmVzcxgBIAEoCV'
        'IMb3duZXJBZGRyZXNz');
...
final $typed_data.Uint8List delegateResourceContractDescriptor =
    $convert.base64Decode('ChhEZWxlZ2F0ZVJlc291cmNlQ29udHJhY3QSIwoNb3duZXJfYWRkcmVzcxgBIAEoCVIMb3duZX'
...
final $typed_data.Uint8List unDelegateResourceContractDescriptor =
    $convert.base64Decode('ChpVbkRlbGVnYXRlUmVzb3VyY2VDb250cmFjdBIjCg1vd25lcl9hZGRyZXNzGAEgASgJUgxvd2'
...
final $typed_data.Uint8List unfreezeBalanceContractDescriptor =
    $convert.base64Decode('ChdVbmZyZWV6ZUJhbGFuY2VDb250cmFjdBIjCg1vd25lcl9hZGRyZXNzGAEgASgJUgxvd25lck'
...
final $typed_data.Uint8List unfreezeAssetContractDescriptor =
    $convert.base64Decode('ChVVbmZyZWV6ZUFzc2V0Q29udHJhY3QSIwoNb3duZXJfYWRkcmVzcxgBIAEoCVIMb3duZXJBZG'
        'RyZXNz');
...
final $typed_data.Uint8List voteAssetContractDescriptor =
    $convert.base64Decode('ChFWb3RlQXNzZXRDb250cmFjdBIjCg1vd25lcl9hZGRyZXNzGAEgASgJUgxvd25lckFkZHJlc3'
...
final $typed_data.Uint8List voteWitnessContractDescriptor =
    $convert.base64Decode('ChNWb3RlV2l0bmVzc0NvbnRyYWN0EiMKDW93bmVyX2FkZHJlc3MYASABKAlSDG93bmVyQWRkcm'
...
final $typed_data.Uint8List withdrawBalanceContractDescriptor =
    $convert.base64Decode('ChdXaXRoZHJhd0JhbGFuY2VDb250cmFjdBIjCg1vd25lcl9hZGRyZXNzGAEgASgJUgxvd25lck'
        'FkZHJlc3M=');
...
final $typed_data.Uint8List triggerSmartContractDescriptor =
    $convert.base64Decode('ChRUcmlnZ2VyU21hcnRDb250cmFjdBIjCg1vd25lcl9hZGRyZXNzGAEgASgJUgxvd25lckFkZH'
...
final $typed_data.Uint8List blockHeaderDescriptor =
    $convert.base64Decode('CgtCbG9ja0hlYWRlchIcCgl0aW1lc3RhbXAYASABKANSCXRpbWVzdGFtcBIgCgx0eF90cmllX3'
...
final $typed_data.Uint8List transactionDescriptor =
    $convert.base64Decode('CgtUcmFuc2FjdGlvbhIcCgl0aW1lc3RhbXAYASABKANSCXRpbWVzdGFtcBIeCgpleHBpcmF0aW'
...
final $typed_data.Uint8List signingInputDescriptor =
    $convert.base64Decode('CgxTaWduaW5nSW5wdXQSPAoLdHJhbnNhY3Rpb24YASABKAsyGi5UVy5Ucm9uLlByb3RvLlRyYW'
...
final $typed_data.Uint8List signingOutputDescriptor =
    $convert.base64Decode('Cg1TaWduaW5nT3V0cHV0Eg4KAmlkGAEgASgMUgJpZBIcCglzaWduYXR1cmUYAiABKAxSCXNpZ2'
