...
final $typed_data.Uint8List chainDescriptor =
    $convert.base64Decode('CgVDaGFpbhIICgRUSE9SEAASBwoDQlRDEAESBwoDRVRIEAISBwoDQk5CEAMSCAoERE9HRRAEEg'
...
final $typed_data.Uint8List errorCodeDescriptor =
    $convert.base64Decode('CglFcnJvckNvZGUSBgoCT0sQABIRCg1FcnJvcl9nZW5lcmFsEAESJQohRXJyb3JfSW5wdXRfcH'
...
final $typed_data.Uint8List errorDescriptor =
    $convert.base64Decode('CgVFcnJvchI1CgRjb2RlGAEgASgOMiEuVFcuVEhPUkNoYWluU3dhcC5Qcm90by5FcnJvckNvZG'
...
final $typed_data.Uint8List assetDescriptor =
    $convert.base64Decode('CgVBc3NldBIzCgVjaGFpbhgBIAEoDjIdLlRXLlRIT1JDaGFpblN3YXAuUHJvdG8uQ2hhaW5SBW'
...
final $typed_data.Uint8List streamParamsDescriptor =
    $convert.base64Decode('CgxTdHJlYW1QYXJhbXMSGgoIaW50ZXJ2YWwYASABKAlSCGludGVydmFsEhoKCHF1YW50aXR5GA'
...
final $typed_data.Uint8List swapInputDescriptor =
    $convert.base64Decode('CglTd2FwSW5wdXQSPAoKZnJvbV9hc3NldBgBIAEoCzIdLlRXLlRIT1JDaGFpblN3YXAuUHJvdG'
...
final $typed_data.Uint8List swapOutputDescriptor =
    $convert.base64Decode('CgpTd2FwT3V0cHV0EjwKCmZyb21fY2hhaW4YASABKA4yHS5UVy5USE9SQ2hhaW5Td2FwLlByb3'
